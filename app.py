...
st.sidebar.title('All data is from the UN Food and Agriculture Organization (FAO)')
st.sidebar.markdown('''
...
st.subheader("There are almost 59 % more people facing hunger in the world than the entire population of India.")
...
#st.bar_chart()
#st.write(df5)
st.subheader("Prevalence of severe food insecurity in the total population (percent) (3-year average)")
...
st.bar_chart(data=df5,y = ['Start','End'], x ='Value', width=0, height=0, use_container_width=True)
#st.subheader()
